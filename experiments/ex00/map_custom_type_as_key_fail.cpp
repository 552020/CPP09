...
// g++ -std=c++98 -o map_custom_type_as_key_fail map_custom_type_as_key_fail.cpp

struct Person {
    std::string firstName;
    std::string lastName;

    // Custom comparison operator - with this commented out the code will fail to compile
